...
const I18N = {
  ...
  zh: {
    ...
    "research.c3t": "在线蒸馏 (OPD)", "research.c3d": "SimpleOPD 与 Agents-A1——跨分词器、跨模型家族、跨时间跨度地把长上下文教师推理蒸馏到紧凑学生模型。",
    "research.c4t": "AI for Science", "research.c4d": "为科学后训练供能的数据集与基准：Biology-Instructions、PHYSICS 以及物理奥赛评测。",
    "hl.title": "研究亮点",
