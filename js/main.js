...
const I18N = {
  ...
  zh: {
    ...
    "about.title": "关于我",
    "about.p1": "我是<b>中国科学技术大学</b>的博士生（2023–2029），研究方向是大模型后训练（LLM post-training）。说白了，就是怎么把基座模型调教成真正能用的模型：<b>监督微调（SFT）</b>、<b>强化学习（RL）</b>、<b>在线蒸馏（OPD）</b>都做。这几年就琢磨两件事：后训练能不能更省、更有依据；模型能不能更会科学推理。",
    "about.p2": "<b>SFT / PEFT 方面</b>：以第一作者身份发表了 GoRA（NeurIPS 2025），用训练时的梯度信息同时决定秩和初始化，数学推理比标准 LoRA 高 5 分以上；还做了 LoRA 变体第一个系统性的梳理，分类、代码库、大规模评测（LoRAFactory）一次配齐；MoE²-LoRA 和 Parametric Skills 是共同一作兼项目负责人，GIDA、E²LoRA 也有参与，两篇都中 ICLR 2026。",
    "about.p3": "<b>RL 和蒸馏方面</b>：参与了 P1、P1-VL，是最早在 IPhO 2025 拿金牌表现的开源模型；做过 PHYSICS 数据集和 Control-R；SimpleOPD 是我一作——不用对齐分词器，就能把长上下文教师的能力装进小模型，Intern-S2-Preview 在 ProofBench 上直接涨了 21.2 分，超过 Gemini-2.5-Pro；还参与过 Agents-A1（35B 打出万亿参数级的效果）和 ExoMind（八项科学基准超过闭源模型）。这些开源模型在 Hugging Face 上累计被下载了 <b>45 万+ 次</b>。",
    "research.title": "研究方向与亮点",
    "research.c1t": "高效 SFT 与 PEFT", "research.c1d": "花一小部分训练成本，做出接近全量微调的效果：GoRA、E²LoRA、MoE²-LoRA、GIDA、Parametric Skills，以及 LoRAFactory 统一研究。",
    "research.c2t": "科学推理强化学习", "research.c2d": "用强化学习把物理奥赛做到金牌级，还能泛化到更广的 STEM 推理：P1、P1-VL、PHYSICS。",
    "research.c3t": "在线蒸馏 (OPD)", "research.c3d": "把长上下文教师的推理能力装进小模型，不用对齐分词器，也不挑模型家族：SimpleOPD、Agents-A1。",
    "research.c4t": "AI for Science", "research.c4d": "面向科学场景的数据集和评测：ExoMind、Biology-Instructions、SuperCLUE、物理奥赛基准等。",
    "pub.title": "论文发表",
...
const HIGHLIGHTS = [
  {
    ...
    items: [
      { name: "GoRA", href: "https://arxiv.org/abs/2502.12171",
        ...
        zh: "第一作者（NeurIPS 2025）· 数学推理 +5.13，高秩下比全量微调还强" },
  ...
  },
  {
    ...
    items: [
      { name: "SimpleOPD", href: "https://arxiv.org/abs/2608.14277",
        ...
        zh: "第一作者 · ProofBench 直接 +21.2 分，超过 Gemini-2.5-Pro（Intern-S2-Preview）" },
  ...
  },
  {
    ...
    items: [
      { name: "ExoMind", href: "https://github.com/AI4SGI/ExoMind",
        ...
        zh: "8 项科学基准平均分 36.2 → 67.5，35B 的小模型打赢 Claude / GPT / Gemini / DeepSeek" },
...
/* low-quality image placeholders (inline, ~24px) */
const LQIP = {"Agents-A1.jpg": "data:image/jpeg;base64,", "Biology-Instructions.jpg": "data:image/jpeg;base64,", "CI-Survey.jpg": "data:image/jpeg;base64,", "Control-R.jpg": "data:image/jpeg;base64,", "E2LoRA.jpg": "data:image/jpeg;base64,", "ExoMind.jpg": "data:image/jpeg;base64,", "GIDA.jpg": "data:image/jpeg;base64,", "GoRA.jpg": "data:image/jpeg;base64,", "LoRA-Variants.jpg": "data:image/jpeg;base64,", "Maize.jpg": "data:image/jpeg;base64,", "MoE2-LoRA.jpg": "data:image/jpeg;base64,", "PHYSICS.jpg": "data:image/jpeg;base64,", "Parametric-Skills.jpg": "data:image/jpeg;base64,", "SimpleOPD.jpg": "data:image/jpeg;base64,", "SuperCLUE.jpg": "data:image/jpeg;base64,"};
...
function renderPubs(filter) {
  ...
  items.forEach((p, idx) => {
    ...
    const hl = p.hl
      ...
      : "";
    const lqip = LQIP[FIG_MAP[p.title]] || "";
    const fig = FIG_MAP[p.title]
      ? '<div class="pub-fig" style="aspect-ratio:' + (FIG_RATIO[p.title] || 1.6) + ";" +
        (lqip ? "background-image:url(" + lqip + ");background-size:cover;background-position:center;" : "") +
        '"><img data-src="img/papers/' + FIG_MAP[p.title] +
...
/* lazy-load figure images as they scroll into view (LQIP placeholder meanwhile) */
function lazyFigures() {
  const imgs = [...document.querySelectorAll(".pub-fig img[data-src]")];
  ...
  // safety net for browsers whose IO never fires
  setTimeout(() => imgs.forEach(load), 4000);
}
